  ...
  <Layout>
      ...
      <div className="frame-60-C61RwL">
        ...
        <div className="phone-isdgOW">
          ...
          <div className="icon-2-Q5MDTp">
            ...
            <div className="active-call-IvlqQS">
              <img className="path215-7T0mBT" src="./import/img/path-215@2x.png" />
              <img className="path216-7T0mBT" src="./import/img/path-216@2x.png" />
            </div>
          </div>
        </div>
        ...
        <div className="frame-62-isdgOW">
          <div className="group-1-lBakbW">
            <img className="line7-3hCxVM" src="./import/img/line-7-11@2x.png" />
            <img className="line8-3hCxVM" src="./import/img/line-8-11@2x.png" />
            <img className="line9-3hCxVM" src="./import/img/line-9-11@2x.png" />
            <img className="line10-3hCxVM" src="./import/img/line-10-11@2x.png" />
            <img className="line11-3hCxVM" src="./import/img/line-11-11@2x.png" />
            <img className="line12-3hCxVM" src="./import/img/line-12-11@2x.png" />
            <img className="line13-3hCxVM" src="./import/img/line-13-11@2x.png" />
            <img className="path71-3hCxVM" src="./import/img/path-71-11@2x.png" />
            <img className="line15-3hCxVM" src="./import/img/line-15-11@2x.png" />
          </div>
        </div>
      </div>
      ...
      <div className="frame-60-C61RwL">
        ...
        <div className="phone-isdgOW">
          ...
          <div className="icon-2-Q5MDTp">
            <div className="ellipse-2-IvlqQS"></div>
            <div className="active-call-IvlqQS">
              <img className="path215-7T0mBT" src="./import/img/path-215-1@2x.png" />
              <img className="path216-7T0mBT" src="./import/img/path-216@2x.png" />
            </div>
          </div>
        </div>
        ...
        <div className="frame-61-isdgOW">
          <div className="group-1-H4hSpH">
            <img className="line7-x5Qw0n" src="./import/img/line-7-53@2x.png" />
            <img className="line8-x5Qw0n" src="./import/img/line-8-53@2x.png" />
            <img className="line9-x5Qw0n" src="./import/img/line-9-53@2x.png" />
            <img className="line10-x5Qw0n" src="./import/img/line-10-53@2x.png" />
            <img className="line11-x5Qw0n" src="./import/img/line-11-53@2x.png" />
            <img className="line12-x5Qw0n" src="./import/img/line-12-53@2x.png" />
            <img className="line13-x5Qw0n" src="./import/img/line-13-53@2x.png" />
            <img className="path71-x5Qw0n" src="./import/img/path-71-53@2x.png" />
            <img className="line15-x5Qw0n" src="./import/img/line-15-53@2x.png" />
          </div>
        </div>
      </div>
    ...
    <div className="contact-tablet-720px screen">
      ...
      <div className="frame-60-C61RwL">
        ...
        <div className="frame-61-isdgOW">
          <div className="group-1-H4hSpH">
            <img className="line7-x5Qw0n" src="./import/img/line-7-54@2x.png" />
            <img className="line8-x5Qw0n" src="./import/img/line-8-53@2x.png" />
            <img className="line9-x5Qw0n" src="./import/img/line-9-54@2x.png" />
            <img className="line10-x5Qw0n" src="./import/img/line-10-54@2x.png" />
            <img className="line11-x5Qw0n" src="./import/img/line-11-53@2x.png" />
            <img className="line12-x5Qw0n" src="./import/img/line-12-54@2x.png" />
            <img className="line13-x5Qw0n" src="./import/img/line-13-54@2x.png" />
            <img className="path71-x5Qw0n" src="./import/img/path-71-53@2x.png" />
            <img className="line15-x5Qw0n" src="./import/img/line-15-54@2x.png" />
          </div>
        </div>
        <div className="form-isdgOW">
          <div className="field-lixMB9">
